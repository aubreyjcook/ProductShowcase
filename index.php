    ...
    <div class="container">
        ...
        <main>
            ...
            <p style="text-align: left; width: 35%; float: left;">
                ...
                <br>
                <br> Brackets can be especially useful at the beginning of a workflow, converting wireframes and mock ups to actual documents in HTML and CSS before converting to PHP.
            </p>

            <div class="left">
                <a href="#large"><img src="images/brackets01.png" alt="screenshot of brackets opening" title="screenshot of brackets opening" height="125"  onclick="change01()" /></a>
                <br>
                <a href="#large"><img src="images/brackets02.png" alt="screenshot of the brackets workspace" title="screenshot of the brackets workspace" height="125" onclick="change02()" /></a>
                <br>
                <a href="#large"><img src="images/brackets03.png" alt="screenshot of the brackets search function" title="screenshot of the brackets search function" height="125" onclick="change03()" /></a>
                <br>
            </div>
